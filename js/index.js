...
//<?php echo $response; ?>
                ...
                if(n >= 0){
                    ...
                    $('.boxy-success').find('.icon-success').attr('title','logged in as, ' + _user );
                    $('.boxy-success').find('.icon-success').stop().fadeIn('slow');
                    document.getElementById("gogo").style.visibility = "visible";
                }
                if(n == -1){
                    console.log('failure');
        ...
        xhttp.send("id="+_user+"&pass="+_pass+"&uid=12345"+"&login=1");
    }
